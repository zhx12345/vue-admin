			...
			submit(){
				this.$refs.dialogForm.validate(async (valid) => {
					if (valid) {
						...
						this.form.parent_id = this.form.parentId
						if ('parentId' in this.form) {
							delete this.form.parentId;
						}

						var res;
						if(this.mode == 'add'){
							res = await this.$API.system.dic.typeAdd.post(this.form);
						}else{
							res = await this.$API.system.dic.typeEdit.put(this.form);
						}
