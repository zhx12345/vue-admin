	...
	<el-container>
		<el-header>
			...
			<div class="right-panel">
				<div class="right-panel-search">
					<el-input v-model="search.keyword" placeholder="等级名称" clearable></el-input>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" @selection-change="selectionChange" stripe>
				...
				<el-table-column label="会员等级" prop="level" width="80">
					<template #default="scope">
						<el-tag type="success">{{ scope.row.level }}</el-tag>
					</template>
				</el-table-column>
				<el-table-column label="等级名称" prop="title"></el-table-column>
				<el-table-column label="成长值" prop="value"></el-table-column>
				<el-table-column label="等级权益" prop="equity"></el-table-column>
				<el-table-column label="等级礼包" prop="gift"></el-table-column>
...
export default {
	...
	data() {
		return {
			...
			apiObj: this.$API.member.level.list,
			selection: [],
			search: {
				keyword: null
			}
