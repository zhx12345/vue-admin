			...
			<div class="login-form">
				...
				<!-- <template v-if="$CONFIG.MY_SHOW_LOGIN_OAUTH">
					...
					<div class="login-oauth">
						<el-button categories="success" icon="sc-icon-wechat" circle @click="wechatLogin"></el-button>
					</div>
				</template> -->
			</div>
		</div>
...
<script>
	...
	export default {
		...
		created: function() {
			...
			console.log('%c SCUI: %c 1.6.9', 'background:#666;color:#fff;border-radius:3px;', '')
			console.log('%c VUE: %c ' + require('vue/package.json').version, 'background:#666;color:#fff;border-radius:3px;', '')
