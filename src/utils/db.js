...
// 打开某个数据库，返回数据库实例
// const generate = await DB.open("dbName")

// 在打开的数据库中添加数据到tablenName表
// await generate.add("tablenName", data)

// 查询
// await generate.get("tablenName", key)

// 查询 根据索引
// await generate.indexGet("tablenName", "indexName", indexVal)

// 修改
// await generate.put("tablenName", data)

// 删除
// await generate.delete("tablenName", key)

// 获取所有
// await generate.getAll("tablenName")

// 清空某个表数据
// await generate.clear("tablenName")

// 获取某个表信息
// generate.getTable("tablenName")
